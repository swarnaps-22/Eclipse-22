...
//		System.out.println("students: "+students);
		...
		case 1:
			if (studentLogin()) {
				...
				int toContinueOption =1;
				do
				{
					out.println("starting again");
					toContinueOption = registerMenu();
					System.out.println(toContinueOption);
				}while(toContinueOption ==1);
	...
	private int registerMenu() {
		...
		out.println("optionPicked:" + optionPicked);
		return optionPicked;
	}
}
